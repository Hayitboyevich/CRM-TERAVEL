...
use Modules\WebHook\Services\InstagramService;
use Modules\WebHook\Services\IpTelefoniyaService;
use Modules\WebHook\Services\TelegramService;
...
return [
    ...
    */
    ...
    'webhook' => [
        ...
        'iptelefoniya' => IpTelefoniyaService::class,
    ],
