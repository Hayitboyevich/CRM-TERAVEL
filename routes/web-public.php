...
Route::get('/features', [FrontController::class, 'feature'])->name('front.feature');
Route::get('/pricing', [FrontController::class, 'pricing'])->name('front.pricing');
Route::get('page/{slug?}', [FrontController::class, 'page'])->name('front.page');
Route::get('language/{lang}', [FrontController::class, 'changeLanguage'])->name('front.language.lang');
