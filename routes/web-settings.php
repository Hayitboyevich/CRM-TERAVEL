...
use App\Http\Controllers\LeadInterestSettingController;
...
//    Route::get('webhook/create', [WebHookController::class, 'create'])->name('webhook.create');
//    Route::post('webhook/store', [WebHookController::class, 'store'])->name('webhook.store');
//    Route::post('webhook/destroy', [WebHookController::class, 'destroy'])->name('webhook.destroy');
    ...
    Route::resource('sms-settings', SmsSettingController::class, ['only' => ['index', 'update']]);
    ...
    Route::resource('lead-interest-settings', LeadInterestSettingController::class);

    Route::get('lead-status-update/{statusId}', [LeadStatusSettingController::class, 'statusUpdate'])->name('leadSetting.statusUpdate');
    Route::get('lead-status-client-from-update/{statusId}', [LeadStatusSettingController::class, 'statusUpdateClientFrom'])->name('leadSetting.statusUpdateClientFrom');
    Route::resource('lead-status-settings', LeadStatusSettingController::class);
    Route::get('edit-deadline-modal/{leadId}', [LeadStatusSettingController::class, 'editDeadline'])->name('deadline.edit');
    Route::put('update-deadline-modal/{leadId}', [LeadStatusSettingController::class, 'updateDeadline'])->name('deadline.update');

    Route::resource('lead-agent-settings', LeadAgentSettingController::class);
    Route::resource('partner-settings', PartnerSettingController::class);
    Route::resource('hotel-settings', HotelSettingController::class);
    ...
    Route::get('order-type-settings/create', [OrderSettingsController::class, 'create'])
        ->name('order-type-settings.create');
    Route::post('order-type-settings/store', [OrderSettingsController::class, 'store'])
        ->name('order-type-settings.store');
...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::get('register-company', [SettingsController::class, 'companyRegister'])->name('company-create');

    Route::post(RoutePath::for('register-company', 'register-company'), [RegisteredUserController::class, 'store'])->name('register-company');
});
