    ...
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        ...
        <div class="d-flex" id="table-actions">
            @if ($addProjectPermission == 'all' || $addProjectPermission == 'added')
                <x-forms.link-primary :link="route('integrations.create.client', $client->id).'?default_client='.$client->id"
                                      class="mr-3 openRightModal" icon="plus"
                                      data-redirect-url="{{ route('clients.show', $client->id) . '?tab=integration' }}">
                    @lang('app.add')
                    @lang('app.integration')
