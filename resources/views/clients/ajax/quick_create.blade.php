...
<x-form id="save-client-data-form">
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
                <x-forms.text fieldId="firstname" :fieldLabel="__('modules.client.clientName')" fieldName="firstname"
                              fieldRequired="true"
                              :fieldValue="$lead->firstname ?? ''"></x-forms.text>
            </div>
            <div class="col-md-12">
                <x-forms.text fieldId="firstname" :fieldLabel="__('modules.client.clientLastname')" fieldName="firstname"
                              fieldRequired="true"
                              :fieldValue="$lead->lastname ?? ''"></x-forms.text>
            </div>
            <div class="col-md-12">
                <x-forms.number fieldId="mobile" :fieldLabel="__('app.mobile')" fieldName="mobile"
                               :fieldValue="$lead->mobile ?? ''">
                </x-forms.number>
            </div>
            <div class="col-md-12">
