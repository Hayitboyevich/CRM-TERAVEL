                ...
                <div class="row p-20">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <x-forms.text fieldId="employee_id" :fieldLabel="__('modules.employees.employeeId')"
                                              ...
                                              :fieldValue="((!$checkifExistEmployeeId) ? ($lastEmployeeID+1) : '')"
                                              fieldRequired="true"
                    ...
                    <div class="col-lg-3">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2 cropper"
                                      :fieldLabel="__('modules.profile.profilePicture')" fieldName="image"
                                      fieldId="image"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.select fieldId="country" :fieldLabel="__('app.country')" fieldName="country"
                            ...
                            @foreach ($countries as $item)
                                <option {{$item->phonecode == "+998" ? "selected" : ''}} data-tokens="{{ $item->iso3 }}"
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <x-forms.input-group style="margin-top:-4px">
                            ...
                            <x-forms.select fieldId="country_phonecode" fieldName="country_phonecode"
                                ...
                                @foreach ($countries as $item)
                                    <option {{$item->phonecode == "+998" ? "selected" : ''}}
