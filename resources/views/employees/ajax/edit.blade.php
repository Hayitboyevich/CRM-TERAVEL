        ...
        <x-form id="save-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <x-forms.text fieldId="employee_id" :fieldLabel="__('modules.employees.employeeId')"
                                              ...
                                              :popover="__('modules.employees.employeeIdHelp')">
                                </x-forms.text>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <x-forms.number fieldId="service_rate" fieldLabel="Процент за обслуживание"
                                                fieldName="service_rate"
                                                :fieldValue="$employee->employeeDetail->service_rate"
                                                fieldPlaceholder="Процент за обслуживание">
                                </x-forms.number>
                            </div>
                            <div class="col-md-4">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="designation"
                                        ...
                                        @foreach ($designations as $designation)
                                            <option @if ($employee->employeeDetail->designation_id == $designation->id) selected
                                                    @endif value="{{ $designation->id }}">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="department"
                                        ...
                                        @foreach ($teams as $team)
                                            <option @if ($employee->employeeDetail->department_id == $team->id) selected
                                                    @endif value="{{ $team->id }}">
                    ...
                    <div class="col-lg-3">
                        ...
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2 cropper"
                                      ...
                                      :fieldValue="($employee->image ? $employee->image_url : $userImage)"
                                      fieldName="image"
                    ...
                    <div class="col-md-4">
                        <x-forms.select fieldId="country" :fieldLabel="__('app.country')" fieldName="country"
                            ...
                            @foreach ($countries as $item)
                                <option @if ($employee->country_id == $item->id) selected
                                        @endif data-mobile="{{ $employee->mobile }}" data-tokens="{{ $item->iso3 }}"
                                        data-phonecode="{{ $item->phonecode }}" data-content="<span
                    ...
                    <div class="col-md-4">
                        <x-forms.select fieldId="gender" :fieldLabel="__('modules.employees.gender')"
                                        fieldName="gender">
                            <option @if ($employee->gender == 'male') selected
                                    @endif value="male">@lang('app.male')</option>
                            <option @if ($employee->gender == 'female') selected
                                    @endif value="female">@lang('app.female')</option>
                            <option @if ($employee->gender == 'others') selected
                    ...
                    <div class="col-md-4">
                        <x-forms.datepicker fieldId="joining_date" :fieldLabel="__('modules.employees.joiningDate')"
                                            fieldName="joining_date" :fieldPlaceholder="__('placeholders.date')"
                                            fieldRequired="true"
                    ...
                    <div class="col-md-4">
                        <x-forms.select fieldId="reporting_to" :fieldLabel="__('modules.employees.reportingTo')"
                                        fieldName="reporting_to" :fieldPlaceholder="__('placeholders.date')"
                                        search="true">
                            <option value="">--</option>
                            @foreach ($employees as $item)
                                <x-user-option :user="$item"
                                               :selected="$employee->employeeDetail->reporting_to == $item->id"/>
                            @endforeach
                        </x-forms.select>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.address')"
                                              :fieldValue="$employee->employeeDetail->address" fieldName="address"
                                              fieldId="address"
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.about')"
                                              ...
                                              :fieldValue="$employee->employeeDetail->about_me">
                            </x-forms.textarea>
                        </div>
                    </div>
                ...
                <div class="row p-20">
                            ...
                            <div class="form-group my-3">
                                ...
                                <div class="d-flex">
                                    <x-forms.radio fieldId="login-yes" :fieldLabel="__('app.yes')" fieldName="login"
                                                   fieldValue="enable"
                                                   :checked="($employee->login == 'enable') ? 'checked' : ''">
                                    </x-forms.radio>
                                    <x-forms.radio fieldId="login-no" :fieldLabel="__('app.no')" fieldValue="disable"
                                                   fieldName="login"
                                                   :checked="($employee->login == 'disable') ? 'checked' : ''">
                                    </x-forms.radio>
                                </div>
                            </div>
                        </div>
                    ...
                    @if (function_exists('sms_setting') && sms_setting()->telegram_status)
                        <div class="col-md-4">
                            <x-forms.number fieldName="telegram_user_id" fieldId="telegram_user_id"
                                            ...
                                            :fieldValue="$employee->telegram_user_id"
                                            :popover="__('sms::modules.userIdInfo')"/>
                        </div>
                    @endif
                    <div class="col-lg-3 col-md-6">
                        <x-forms.datepicker fieldId="probation_end_date"
                                            :fieldLabel="__('modules.employees.probationEndDate')"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.datepicker fieldId="notice_period_start_date"
                                            :fieldLabel="__('modules.employees.noticePeriodStartDate')"
                                            fieldName="notice_period_start_date"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.datepicker fieldId="notice_period_end_date"
                                            :fieldLabel="__('modules.employees.noticePeriodEndDate')"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.select fieldId="employment_type" :fieldLabel="__('modules.employees.employmentType')"
                            ...
                            <option value="full_time"
                                    @if($employee->employeeDetail->employment_type == 'full_time') selected @endif>@lang('app.fullTime')</option>
                            <option value="part_time"
                                    @if($employee->employeeDetail->employment_type == 'part_time') selected @endif>@lang('app.partTime')</option>
                            <option value="on_contract"
                                    @if($employee->employeeDetail->employment_type == 'on_contract') selected @endif>@lang('app.onContract')</option>
                            <option value="internship"
                                    @if($employee->employeeDetail->employment_type == 'internship') selected @endif>@lang('app.internship')</option>
                            <option value="trainee"
                                    @if($employee->employeeDetail->employment_type == 'trainee') selected @endif>@lang('app.trainee')</option>
                        </x-forms.select>
                    </div>

                    <div class="col-lg-3 col-md-6 d-none internship-date">
                        <x-forms.datepicker fieldId="internship_end_date"
                                            :fieldLabel="__('modules.employees.internshipEndDate')"
                    ...
                    <div class="col-lg-3 col-md-6 d-none contract-date">
                        <x-forms.datepicker fieldId="contract_end_date"
                                            :fieldLabel="__('modules.employees.contractEndDate')"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.select fieldId="marital_status" :fieldLabel="__('modules.employees.maritalStatus')"
                            ...
                            <option value="married"
                                    @if($employee->employeeDetail->marital_status == 'married') selected @endif>Married
                            </option>
                            <option value="unmarried"
                                    @if($employee->employeeDetail->marital_status == 'unmarried') selected @endif>
                                Unmarried
                            </option>
                        </x-forms.select>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 d-none marriage_date">
                        <x-forms.datepicker fieldId="marriage_anniversary_date"
                                            :fieldLabel="__('modules.employees.marriageAnniversaryDate')"
                                            fieldName="marriage_anniversary_date"
                                            :fieldPlaceholder="__('placeholders.date')"
