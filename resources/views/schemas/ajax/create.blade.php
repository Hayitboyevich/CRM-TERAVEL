    ...
    <x-form id="save-schema-data-form">
        <div class="bg-white rounded">
            ...
            <div class="section">
                <div class="p-20 row">
                    <div class="col-4 ">
                        <x-forms.text fieldName="name" fieldLabel="Name" fieldId="name" fieldRequired="true">
                        </x-forms.text>
                        <x-forms.text fieldName="description" fieldLabel="Description" fieldId="description">
                        </x-forms.text>
                        ...
                        <x-forms.button-primary id="" class="layout-build mt-4">
                            Сформировать схему
...
<script>
    $(document).ready(function () {
        $('#save-schema-form').click(function () {
            ...
            const url = "{{ route('schema.store') }}";
            let data = $('#save-schema-data-form').serialize();

            saveClient(data, url, "#save-schema-form");
        });
