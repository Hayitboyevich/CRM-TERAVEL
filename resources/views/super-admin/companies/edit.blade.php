                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="timezone" id="timezone" class="form-control select2">
                                            @foreach($timezones as $tz)
                                                <option
                                                    @if($company->timezone == $tz) selected @endif>{{ $tz }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                @if( $field->type == 'text')
                                                    <input type="text"
                                                           ...
                                                           value="{{$company->custom_fields_data['field_'.$field->id] ?? ''}}">
                                                ...
                                                @elseif($field->type == 'textarea')
                                                    <textarea name="custom_fields_data[{{$field->name.'_'.$field->id}}]"
                                                              ...
                                                              cols="3">{{$company->custom_fields_data['field_'.$field->id] ?? ''}}</textarea>
                                                            ...
                                                            <label class="radio-inline @if($key == 0) p-0 @endif">
                                                                <div class="radio radio-info">
                                                                    <input type="radio"
                                                                           ...
                                                                           value="{{$value}}"
                                                                           @if(isset($company) && $company->custom_fields_data['field_'.$field->id] == $value) checked
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="password" name="password"
                                                   value="">
                                            <span
                                                class="help-block"> @lang('modules.employees.updateAdminPasswordNote')</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>@lang('modules.accountSettings.passScanStatus')</label>
                                    <select name="can_pass_scan" id="can_pass_scan" class="form-control">
                                        <option value=1
                                                @if($company->can_pass_scan == 1) selected @endif>@lang('app.active')</option>
                                        <option value=0
                                                @if($company->can_pass_scan == 0) selected @endif>@lang('app.inactive')</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="company_name">@lang('modules.accountSettings.currMonthScanNum')</label>
                                    <input type="text" class="form-control" readonly
                                           value="{{ $currMonthScanNumber->number ?? '' }}">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="company_name">@lang('modules.accountSettings.lastMonthScanNum')</label>
                                    <input type="text" class="form-control" readonly
                                           value="{{ $lastmonthScanNumber?->number ?? 0 }}">
                                </div>
                            </div>
                        </div>
