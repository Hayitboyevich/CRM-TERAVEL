    ...
    <x-filters.filter-box>
        ...
        <x-filters.more-filter-box>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="type" id="type" data-live-search="true" data-container="body" data-size="8">
                            <option value="all">@lang('app.all')</option>
...
@push('scripts')
    ...
    <script>
        ...
        $('#clientID, #project_id, #status, #type').on('change keyup', function() {
        ...
        $('body').on('change', '.payment-status', function () {
            ...
            if (typeof id !== 'undefined') {
                $.easyAjax({
                    url: "{{ route('payment.change_status_index') }}",
                    type: "POST",
                    blockUI: true,
