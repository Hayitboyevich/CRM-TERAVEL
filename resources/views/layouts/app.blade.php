...
<script>
    ...
    const datepickerConfig = {
        ...
        showAllDates: true,
        customDays: {!!  json_encode(GlobalSetting::getDaysOfWeek())!!},
        customMonths: {!!  json_encode(GlobalSetting::getMonthsOfYear())!!},
        customOverlayMonths: {!!  json_encode(GlobalSetting::getMonthsOfYear())!!},
    ...
    const daterangeLocale = {
        ...
        "monthNames": {!!  json_encode(GlobalSetting::getMonthsOfYear())!!},
        "daysOfWeek": {!!  json_encode(GlobalSetting::getDaysOfWeek())!!},
