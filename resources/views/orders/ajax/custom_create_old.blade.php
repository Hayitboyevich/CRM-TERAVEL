        ...
        <div class="row px-lg-4 px-md-4 px-3 pt-3">
            ...
            <div class="col-md-4 mb-4">
                <div class="form-group mb-lg-0 mb-md-0 mb-4 mt-3">
                    <x-forms.label class="mb-12" fieldId="order_number" :fieldLabel="__('modules.orders.orderNumber')"
                                   fieldRequired="true">
                    </x-forms.label>
                    <x-forms.input-group>
                        <x-slot name="prepend">
            ...
            <div class="col-md-4">
                ...
                <input type="hidden" name="integration_id" id="integration_id" value="{{ $integration->id }}">
                ...
                />
                {{--                <x-client-selection-dropdown :clients="$clients" :selected="$client->id ?? null"/>--}}
            </div>
            <!-- CLIENT END -->
                ...
                <div class="c-inv-desc-table w-100 d-lg-flex d-md-flex d-block">
                    <table width="100%">
                        ...
                        <tr class="text-dark-grey font-weight-bold f-14">
                            ...
                            {{--                            <td width="17%" class="border-0 bblr-mbl"--}}
                            {{--                                align="right">@lang("modules.invoices.amount")</td>--}}
                        </tr>
                        <tr>
                            <td class="border-bottom-0 btrr-mbl btlr">
                                <input type="text" class="form-control f-14 border-0 w-100 item_name"
                                       value="{{$integration->tour_name}}"
                            ...
                            <td class="border-bottom-0 d-block d-lg-none d-md-none">' +
                                <textarea class="f-14 border-0 w-100 mobile-description" name="item_summary[]"
                                          placeholder="@lang("placeholders.invoices.description")">{{$integration->program_name}}

                                </textarea>
                            </td>
                            <td class="border-bottom-0">
                                <input type="text" min="1"
                                       value="{{$integration->adults_count}}"
                                       class="form-control f-14 border-0 w-100 text-right hsn_sac_code"
                                       name="adults_count">
                            </td>
                            <td class="border-bottom-0">
                                <input type="number" min="1"
                                       value="{{$integration->children_count}}"
                            ...
                            <td class="border-bottom-0">
                                <input type="number" min="1" class="mb-2 f-14 border-0 w-100 text-right cost_per_item"
                                       placeholder="0" value="{{$integration->nights_count_from}}"
                                       name="nights_count_from">

                                <input type="number" min="1" class="f-14 border-0 w-100 text-right cost_per_item"
                                       placeholder="0" value="{{$integration->nights_count_to}}"
                                       name="nights_count_to">
                            </td>
                            <td class="border-bottom-0">
                                <div class="select-others height-45 rounded border-0">
                                    <select disabled readonly multiple="multiple"
                                            class="select-picker type customSequence"
                                            data-size="3">'
                                        <option selected>{{$integration->hotel_name}}</option>
                                    </select>
...
<script>
    $(document).ready(function () {
        ...
        $('#total_paid').on('keyup', function () {
            ...
            $('#total_remind').val(due);
            console.log(parseInt(total));
            console.log(parseInt(paid));
