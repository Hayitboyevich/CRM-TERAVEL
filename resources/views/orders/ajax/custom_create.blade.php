@php
    $addProductPermission = user()->permission('add_payments');
@endphp
    ...
    <x-form class="c-inv-form" id="saveInvoiceForm">
        ...
        <div class="row px-lg-4 px-md-4 px-3 pt-3">
            ...
            <div class="col-md-3 mt-1">
                <x-forms.select fieldId="partner_id" :fieldLabel="__('app.partner')" fieldName="partner"
                                search="true">
                    <option value="">--</option>
            ...
            <div class="col-md-3 mt-1">
                <x-forms.text
                        fieldLabel="Курс валюты в партнере" fieldName="partner_rate"
                        ...
                        <tr>
                            ...
                            <td class="border-bottom-0">
                                <div class="select-others height-45 rounded border-0">
                                    <input type="text" class="form-control f-14 border-0 w-100 item_name"
                                           value="{{$integration?->hotel_name ?? 0}}"
                                           name="hotel_name">
                        ...
                        <table width="100%">
                            ...
                            <tr class="bg-amt-grey f-16 f-w-500">
                                ...
                                <td width="38%"><input class="form-control f-14 border-0 w-100 text-right hsn_sac_code"
                                                       ...
                                                       value="0"></td>
                                <td width="12%">
                                    <select id="currency" name="currency_id" disabled>
