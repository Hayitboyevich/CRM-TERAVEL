                ...
                <div class="form-group mb-lg-0 mb-md-0 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="invoice_number" id="invoice_number"
                               ...
                               value="@if (is_null($lastInvoice)) 1 @else{{ $lastInvoice }} @endif" placeholder="0019"
                               aria-label="0019" aria-describedby="basic-addon1">
                    </div>
                </div>
            </div>
            <!-- INVOICE NUMBER END -->
                    ...
                    <div class="form-group c-inv-select mb-4">
                        <select class="form-control select-picker" data-live-search="true" data-size="8"
                            ...
                            @foreach ($clients as $item)
                                <x-user-option :user="$clientOpt"
                                               :selected="isset($estimate) && $item->id == $estimate->client_id"/>
                            @endforeach
                        </select>
                    </div>
                @endif
                ...
                <div class="form-group c-inv-select mb-lg-0 mb-md-0 mb-4">
                    ...
                    <p class="d-none" id="add-shipping-field">
                        <textarea class="form-control f-14 pt-2" rows="3" placeholder="@lang('placeholders.address')"
                                  ...
                                  id="shipping_address">@if (isset($estimate) && $estimate->client)
                                {!! nl2br($estimate->client->clientDetails->shipping_address) !!}
                            @endif</textarea>
                    </p>
                </div>
