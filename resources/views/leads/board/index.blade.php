        ...
        <div class="d-block d-lg-flex d-md-flex my-3">
            ...
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                @if ($addClientPermission == 'all' || $addClientPermission == 'added' || $addClientPermission == 'both')
                    <x-forms.link-primary :link="route('leads.create')"
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0" role="group">
                ...
                <a href="{{ route('leadboards.index') }}" class="btn btn-secondary f-14 btn-active"
                   data-toggle="tooltip"
    ...
    <script>
        function showTable() {
            ...
            var url = "{{ route('leadboards.index') }}?startDate=" + encodeURIComponent(startDate) + '&endDate=' +
                ...
                '&searchText=' + searchText + '&min=' + min + '&max=' + max;
        ...
        $('body').on('click', '.load-more-tasks', function () {
            ...
            var url = "{{ route('leadboards.load_more') }}?startDate=" + encodeURIComponent(startDate) +
                ...
                '&totalTasks=' + totalTasks + '&min=' + min + '&max=' + max;
        ...
        $('body').on('click', '.edit-deadline', function () {
            var leadId = $(this).children('a').data('lead-id');
            console.log($(this));
            var url = "{{ route('deadline.edit', ':id') }}";
