    ...
    <div class="content-wrapper">
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar dd">
            ...
            <div id="table-actions" class="flex-grow-1 align-items-center">
                <x-forms.link-primary :link="route('applications.create')"
                ...
                {{--                <x-forms.link-secondary :link="route('applications.import')"--}}
...
@push('scripts')
    ...
    <script>
        ...
        const showTable = () => {
            window.LaravelDataTables["applications-table"].draw(false);
        }
        $(document).ready(function () {
            $('#applications-table').on('click', 'tbody tr', function () {
                ...
                success: function (response) {
                    if (response.status === "success") {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                var url = "{{ route('applications.destroy', ':id') }}";
                                url = url.replace(':id', id);
                                $.easyAjax({
                                    type: 'POST',
                                    url: url,
        ...
        const applyQuickAction = () => {
            var rowdIds = $("#applications-table input:checkbox:checked").map(function () {
                return $(this).val();
            }).get();

            const url = "{{ route('applications.apply_quick_action') }}?row_ids=" + rowdIds;
