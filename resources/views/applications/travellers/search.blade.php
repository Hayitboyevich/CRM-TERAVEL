...
@section('content')
    <div class="custom-center">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <x-forms.link-primary :link="route('applications.travellers.create', $applicationId)"
    ...
    <script>
        $(document).ready(function () {
            ...
            function searchFunction(searchTerm) {
                ...
                $.ajax({
                    url: '{{route('applications.search', $applicationId)}}',
                    type: 'GET',
                    data: {q: searchTerm},
                ...
                if (results.length === 0) {
                    ...
                    results.forEach(result => {
                        ...
                        const resultItem = $('<div class="add-travel">')
                            ...
                            .text(result.mobile + " - " + (result.firstname ?? "")
                                + " - "
                                + (result.lastname ?? ""));
            ...
            $('body').on('click', '.result-item', function () {
                ...
                var url = "{{ route('applications.addTraveller', [$applicationId, ':id']) }}";
