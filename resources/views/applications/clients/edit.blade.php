    ...
    <div class="col-sm-12">
        <x-form id="save-data-form" method="PUT">
                        ...
                        <div class="form-group my-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="birthday" name="birthday"
                                       value="{{ $client?->birthday?->format('Y-m-d') }}"
            ...
            <div class="add-client-passport bg-white rounded">
                ...
                {{--                                      fieldId="passport_image" :fieldValue="$client->passportDoc?->doc_url"--}}
                {{--                        />--}}
                {{--                    </div>--}}
                {{--                    <div class="col-md-4">--}}
                ...
                {{--                            @foreach($countries as $country)--}}
                {{--                                <option--}}
                {{--                                        @if($country->id == $client?->localPassport?->residence_id) selected--}}
                {{--                                        @endif--}}
                ...
                {{--                                      :fieldValue="$client?->localPassport?->place_of_birth"--}}
                {{--                                      fieldLabel="Место рождения:">--}}
                {{--                        </x-forms.text>--}}
                {{--                    </div>--}}
                {{--                    <div class="col-md-4">--}}
                ...
                {{--                                      :fieldValue="$client?->localPassport?->date_of_expiry"--}}
                {{--                                      fieldLabel="Срок действия">--}}
                {{--                        </x-forms.text>--}}
                {{--                    </div>--}}
                {{--                    <div class=" col-md-4">--}}
                ...
                {{--                                        :fieldValue="$client?->localPassport?->given_department">--}}
                {{--                        </x-forms.number>--}}
                {{--                    </div>--}}
                {{--                    <div class="col-md-4">--}}
                {{--                        <x-forms.number fieldName="passport[personal_number]" fieldId="passport[personal_number]"--}}
                {{--                                        :fieldValue="$client?->localPassport?->personal_number"--}}
                {{--                                        fieldLabel="ИНН">--}}
                {{--                        </x-forms.number>--}}
                {{--                    </div>--}}
                ...
                {{--                            @foreach($countries as $country)--}}
                {{--                                <option--}}
                {{--                                        @if($country->id == $client?->localPassport?->living_country_id) selected--}}
                {{--                                        @endif--}}
                {{--                                        value="{{$country->id}}">{{$country->name}}--}}
                {{--                                </option>--}}
                {{--                            @endforeach--}}
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#save-form').click(function () {
            const url = "{{ route('applications.clients.update', [$application->id,$client->id]) }}";
