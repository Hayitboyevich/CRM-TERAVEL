...
<div class="settings-sidebar bg-white py-3" id="mob-settings-sidebar">
    ...
    <ul class="settings-menu" id="settingsMenu">
        ...
        @endif
            ...
            <x-setting-menu-item :active="$activeMenu" menu="webhook" :href="route('webhook.index')"
                                 :text="__('app.menu.webhook')"/>
        ...
        @endif
        <x-setting-menu-item :active="$activeMenu" menu="integration_settings"
                             :href="route('integration-settings.index')"
                             :text="__('app.menu.integrationSettings')"/>
        ...
        @if(isWorksuite())
            ...
            @endif
            @if (user()->permission('manage_sms_settings') == 'all')
                <x-setting-menu-item :active="$activeMenu" menu="sms_settings"
                                     :href="route('sms-settings.index')" :text="__('app.menu.smsSettings')"/>
            @endif
