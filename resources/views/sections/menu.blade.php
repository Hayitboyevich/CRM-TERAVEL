<ul>
    ...
    || $sidebarUserPermissions['view_finance_dashboard'] == 4
        ...
        <x-menu-item icon="house" :text="__('app.menu.dashboard')">
            ...
            <div class="accordionItemContent pb-2">
                ...
                <x-sub-menu-item :link="route('customDashboard')"
                                 :text="__('app.menu.orderStats')"/>
    ...
    @if (!in_array('client', user_roles()) && in_array('leads', user_modules()) && $sidebarUserPermissions['view_lead'] != 5 && $sidebarUserPermissions['view_lead'] != 'none')
        <x-menu-item icon="person" :text="__('app.menu.lead')" :link="route('leadboards.index')">
            <x-slot name="iconPath">
                <path
    ...
    @endif
    <x-menu-item icon="person" :text="__('app.order')" :link="route('applications.index')">
        <x-slot name="iconPath">
            <path
                    d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
        </x-slot>
    </x-menu-item>
    <x-menu-item icon="house" :text="__('app.menu.debt')">
        <x-slot name="iconPath">
            <path fill-rule="evenodd"
                  d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
            <path fill-rule="evenodd"
        ...
        <div class="accordionItemContent pb-2">
            <x-sub-menu-item :link="route('debit.index')"
                             :text="__('app.clientDebits')"/>

            <x-sub-menu-item :link="route('partner-debits.index')"
                             :text="__('app.debtFromPartners')"/>
        </div>
    </x-menu-item>

    <x-menu-item icon="house" :text="__('app.myOperator')">
        <x-slot name="iconPath">
            <path fill-rule="evenodd"
                  d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
            <path fill-rule="evenodd"
        ...
        <div class="accordionItemContent pb-2">
            <x-sub-menu-item :link="route('schema.index')"
                             :text="__('app.menu.schemaPlaces')"/>
            <x-sub-menu-item :link="route('packages.index')"
                             :text="__('app.menu.servicePackages')"/>
            <x-sub-menu-item :link="route('services.index')"
                             :text="__('app.menu.services')"/>

        </div>
    </x-menu-item>
    {{--    @if (!in_array('client', user_roles()) && in_array('kpi', user_modules()) && $sidebarUserPermissions['view_kpi'] != 5 && $sidebarUserPermissions['view_kpi'] != 'none')--}}

    <x-menu-item icon="person" text="KPI" :link="route('kpi.index')">
        <x-slot name="iconPath">
            <path
                    d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
        </x-slot>
    ...
    <!-- NAV ITEM - PARTNERS MENU -->
    {{--    @if (!in_array('client', user_roles()) && in_array('partner', user_modules()) && $sidebarUserPermissions['view_partner'] != 5 && $sidebarUserPermissions['view_partner'] != 'none')--}}
    <x-menu-item icon="person" :text="__('app.menu.partners')" :link="route('partners.index')">
        <x-slot name="iconPath">
            <path
                    d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
        </x-slot>
    ...
    @endif
    {{--    <x-menu-item icon="note" :text="__('app.menu.chat')" :link="route('chat.index')">--}}
    {{--        <x-slot name="iconPath">--}}
    {{--            <path fill-rule="evenodd"--}}
    {{--                  d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022zM6 8.694 1 10.36V15h5V8.694zM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15z"/>--}}
    {{--            <path--}}
    ...
    @if (in_array('admin', user_roles())
        ...
        <x-menu-item icon="building" :text="__('app.menu.actions')" :link="route('actions.index')">
            <x-slot name="iconPath">
                <path fill-rule="evenodd"
                      d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022zM6 8.694 1 10.36V15h5V8.694zM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15z"/>
                <path
    ...
    <!-- NAV ITEM - SMS MENU -->
    @if(in_array('demosuperadmin', user_roles()) || in_array('admin', user_roles()) || Arr::get($sidebarUserPermissions, 'view_sms') =='all')

        <x-menu-item icon="building" text="СМС рассылка" :link="route('sms.index')">
            <x-slot name="iconPath">
                <path fill-rule="evenodd"
                      d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022zM6 8.694 1 10.36V15h5V8.694zM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15z"/>
                <path
    ...
    <!-- NAV ITEM - SETTINGS COLLAPASE MENU -->
    <!-- NAV ITEM - Marketing -->
    <x-menu-item icon="gear" :text="__('app.marketing')">
        <x-slot name="iconPath">
        ...
        <div class="accordionItemContent pb-2">
            <x-sub-menu-item :link="route('marketing.index')" :text="__('app.menu.leadStats')"/>
        </div>
    </x-menu-item>

    <!-- NAV ITEM - Register -->
    @if(company()->allow_client_signup)
        <x-menu-item icon="gear" :text="__('app.companyRegister')"
                     :link="route('company-create')">
            <x-slot name="iconPath">
                <path
                        d="M8 4.754a3.246 3.246 0 1 0 0 6.492 3.246 3.246 0 0 0 0-6.492zM5.754 8a2.246 2.246 0 1 1 4.492 0 2.246 2.246 0 0 1-4.492 0z"/>
                <path
                        d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52l-.094-.319zm-2.633.283c.246-.835 1.428-.835 1.674 0l.094.319a.1.1 0 0 0 .145.059l.291-.16c.764-.415 1.6.42 1.184 1.185l-.159.292a.1.1 0 0 0 .059.145l.318.094c.835.246.835 1.428 0 1.674l-.319.094a.1.1 0 0 0-.059.145l.16.291c.415.764-.42 1.6-1.185 1.184l-.291-.159a.1.1 0 0 0-.145.059l-.094.318c-.246.835-1.428.835-1.674 0l-.094-.319a.1.1 0 0 0-.145-.059l-.292.16c-.764.415-1.6-.42-1.184-1.185l.159-.291a.1.1 0 0 0-.059-.145l-.318-.094c-.835-.246-.835-1.428 0-1.674l.319-.094a.1.1 0 0 0 .059-.145l-.16-.292c-.415-.764.42-1.6 1.185-1.184l.292.159a.1.1 0 0 0 .145-.059l.094-.318z"/>
            </x-slot>
        </x-menu-item>
    @endif

    @if(auth()->user()->super_admin == 1)
        <x-menu-item icon="person" :text="__('app.superAdminPanel')"
                     :link="route('super-admin.packages.index')">
            <x-slot name="iconPath">
                <path
                    d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
            </x-slot>
