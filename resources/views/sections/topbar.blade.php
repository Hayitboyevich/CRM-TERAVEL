...
<header class="main-header clearfix bg-white" id="header">
    ...
    <div class="page-header-right float-right d-flex align-items-center justify-content-end">
        ...
        <ul>
            <!-- New List Item for Currency Rates START -->
            <li data-toggle="tooltip" data-placement="top" title="rate" class="d-none d-sm-block">
                <div class="d-flex align-items-center">
                    <div class="header-icon-box">
                       <span class="currency-rate">
                            1 USD = UZS
                            @php
                                $exchangeRate = (company()->currency->currency_code == 'USD') ? company_uzs()->exchange_rate : company_usd_rate();
                                echo $exchangeRate;
                            @endphp
                       </span>
                    </div>
            ...
            <!-- New List Item for Currency Rates END -->
