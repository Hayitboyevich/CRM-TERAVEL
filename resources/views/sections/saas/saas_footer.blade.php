...
{{--                                           href="{{ route('front.signup.index') }}">{{ $frontMenu->get_start }}</a>--}}
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"
{{--                                       href="{{ route('front.feature') }}">{{ $frontMenu->feature }}--}}
                                      >{{ $frontMenu->feature }}
                                    </a>
                                </li>
                                <li class="nav-item">
{{--                                    <a class="nav-link" href="{{ route('front.pricing') }}">{{ $frontMenu->price }}</a>--}}
                                    <a class="nav-link" >{{ $frontMenu->price }}</a>
                                </li>
                                <li class="nav-item">
...
{{--                                        <a href="{{ route('login') }}" class="nav-link">{{ $frontMenu->login }}</a>--}}
                                        <a  class="nav-link">{{ $frontMenu->login }}</a>
                                    @endif
                                </li>
                            </ul>
...
{{--                                <a class="nav-link" href="{{ route('front.contact') }}">{{ $frontMenu->contact }}</a>--}}
                                <a class="nav-link" href="">{{ $frontMenu->contact }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
{{--                        <option value="{{ route('front.language.lang', 'en') }}" @if($locale=='en' ) selected @endif>--}}
                        <option @if($locale=='en' ) selected @endif>
                            English
                        </option>
