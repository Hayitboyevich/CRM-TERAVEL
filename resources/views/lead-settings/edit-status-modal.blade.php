                ...
                <div class="row">
                    <div class="col-sm-4 col-md-12 col-lg-6">
                        <x-forms.text fieldId="type" :fieldLabel="__('modules.lead.leadStatus')"
                                      ...
                                      :fieldPlaceholder="__('placeholders.status')" :fieldValue="$status->type">
                        </x-forms.text>
                    </div>

                    <div class="col-sm-4 col-md-12 col-lg-6">
                        <x-forms.number fieldId="time" :fieldLabel="'Cрок (в минутах)'"
                                        fieldName="time" fieldRequired="false"
                                        :fieldPlaceholder="__('placeholders.status')" :fieldValue="$status->time">
                        </x-forms.number>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-12 col-lg-6">
                        <div id="colorpicker" class="input-group">
                            <div class="form-group my-3 text-left">
                                ...
                                <x-forms.input-group>
                                    <input type="text" name="label_color" id="colorselector"
                                           value="{{ $status->label_color }}"
