<div class="row">
    <div class="col-sm-12">
        <x-form id="save-partner-data-form" method="PUT">
...
<script>
    $(document).ready(function () {
        ...
        $('#save-partner-form').click(function () {
            ...
            const url = "{{ route('partners.update', $partner->id) }}";
            let data = $('#save-partner-data-form').serialize();
