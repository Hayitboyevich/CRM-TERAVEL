...
class Company extends BaseModel
{
    ...
    use HasFactory, SuperadminCustomFieldsTrait;
    ...
    public function metricaGoals()
    {
        return $this->hasMany(CompanyMetricaGoals::class);
    }
    ...
    public function passportScans(): HasMany
    {
        return $this->hasMany(PassportScan::class);
    }
