 ...
 * @property int $rtl
 * @property-read Collection|TicketAgentGroups[] $agent
 * @property-read int|null $agent_count
 * @property-read Collection|Ticket[] $agents
 * @property-read int|null $agents_count
 * @property-read Collection|Attendance[] $attendance
 * @property-read Collection|Leave[] $leaves
 * @property-read int|null $attendance_count
 * @property-read Collection|EventAttendee[] $attendee
 ...
 * @property-read Collection|EmployeeDocument[] $documents
 * @property-read int|null $documents_count
 * @property-read Collection|EmployeeDetails[] $employee
 * @property-read int|null $employee_count
 * @property-read EmployeeDetails|null $employeeDetail
 * @property-read EmployeeDetails|null $employeeDetails
 * @property-read mixed $icon
 * @property-read mixed $image_url
 * @property-read mixed $modules
 * @property-read mixed $unread_notifications
 * @property-read mixed $user_other_role
 * @property-read Collection|EmployeeTeam[] $group
 * @property-read int|null $group_count
 * @property-read Lead|null $lead
 * @property-read Collection|LeadAgent[] $leadAgent
 * @property-read int|null $lead_agent_count
 * @property-read Collection|EmployeeLeaveQuota[] $leaveTypes
 * @property-read int|null $leave_types_count
 * @property-read Collection|ProjectMember[] $member
 * @property-read int|null $member_count
 * @property-read DatabaseNotificationCollection|DatabaseNotification[] $notifications
 * @property-read int|null $notifications_count
 * @property-read Collection|Permission[] $permissionTypes
 ...
 * @property-read Collection|EmployeeShiftSchedule[] $shifts
 ...
 * @property-read Collection|EmergencyContact[] $emergencyContacts
 ...
 * @property-read Collection|EmployeeShift[] $employeeShift
 * @property-read int|null $employee_shift_count
 * @property-read Collection|EmployeeDetails[] $reportingTeam
 * @property-read int|null $reporting_team_count
 * @property-read int|null $shifts_count
 * @property-read Collection|ProjectTemplateMember[] $templateMember
 ...
 * @property-read Collection|Appreciation[] $appreciations
 * @property-read int|null $appreciations_count
 * @property-read Collection|Appreciation[] $appreciationsGrouped
 * @property-read int|null $appreciations_grouped_count
 * @property-read Collection|ProjectTimeLog[] $projectTimeLog
 * @property string|null $stripe_id
 * @property string|null $pm_type
 * @property string|null $pm_last_four
 * @property string|null $trial_ends_at
 * @property-read Collection<int, ProjectTimeLog> $timeLogs
 * @property-read int|null $time_logs_count
 * @property-read Collection<int, VisaDetail> $visa
 ...
 * @property-read Collection<int, TicketGroup> $agentGroup
...
class User extends BaseModel implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract
{
    ...
    public $dates = ['created_at', 'updated_at', 'last_login', 'two_factor_expires_at', 'birthday'];
    ...
    protected $fillable = [
        ...
        'country_phonecode', 'gender', 'birthday', 'name', 'email',
        'source_id', 'company_id', 'password', 'locale', 'passport_id',
        'foreign_passport_id'
    ];
    /**
    ...
    {
        return \App\Models\User::withoutGlobalScopes(['active', CompanyScope::class])
            ->where('super_admin', '1')
            ->get();
    }
     ...
     * @return false|mixed
     */
    public function passportDoc()
    {
        return $this->hasOne(ClientDocument::class, 'user_id')->where('name', 'Паспорт');
    }

    // phpcs:ignore

    public function foreignPassportDoc()
    {
        return $this->hasOne(ClientDocument::class, 'user_id')->where('name', 'Загранпаспорт');
    }
    ...
    public function localPassport(): HasOne
    {
        return $this->hasOne(ClientPassport::class, 'client_id', 'id')->where('passport_type', 'passport');
    }

    public function foreignPassport(): HasOne
    {
        return $this->hasOne(ClientPassport::class, 'client_id', 'id')->where('passport_type', 'touristic');
    }

    public function lead(): HasOne
    {
        return $this->hasOne(Lead::class, 'client_id');
    }
    ...
    {
        $users = \App\Models\User::withoutGlobalScopes(['active', CompanyScope::class])
            ->where('super_admin', '1')
    ...
    {
        return \App\Models\User::withoutGlobalScope('active')->join('role_user', 'role_user.user_id', '=', 'users.id')
            ->join('roles', 'roles.id', '=', 'role_user.role_id')
            ->select('users.*')
