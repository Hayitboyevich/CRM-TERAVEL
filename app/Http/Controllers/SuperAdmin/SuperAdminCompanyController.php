...
class SuperAdminCompanyController extends SuperAdminBaseController
{
    ...
    public function edit($id)
    {
        ...
        $this->currMonthScanNumber = $this->company->passportScans()->where('date', date('m-Y'))->first();
        $this->lastmonthScanNumber = $this->company->passportScans()->where('date', date('m-Y', strtotime('last month')))->first();
...
//        $user->email = $request->company_email ?? null;
//
...
//        $user->save();
    ...
    public function storeAndUpdate($company, $request)
    {
        ...
        $company->can_pass_scan = $request->can_pass_scan;
