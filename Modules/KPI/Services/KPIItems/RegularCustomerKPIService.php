...
class RegularCustomerKPIService extends KPIAbstract implements KPIInterface
{
    ...
    {
        $leads = Lead::query()
            ->select(['*', DB::raw('COUNT(leads.client_id) as totalClient')])
    ...
    {
        return 'RegularCustomerKPIService';
    }
}